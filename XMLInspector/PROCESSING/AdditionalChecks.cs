...
namespace XMLInspector.PROCESSING
{
    ...
    {
        public static void ImportFileToDb(SQLiteConnection Conn,XElement Elem,LOGGING.DoublesList DList, string FileName)
        {
        ...
        public static void GetDoubles(SQLiteConnection Conn, LOGGING.DoublesList DList)
        {
